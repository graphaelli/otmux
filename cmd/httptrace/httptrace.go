...
/*
copied from https://github.com/davecheney/httpstat/blob/master/main.go @ e043eda4a6e7801fef0b74e1e4c67a1190d3bd85
*/
...
func visit(url *url.URL) {
	...
	req, tracer = TraceRequest(opentracing.GlobalTracer(), req)
	defer tracer.Finish()
